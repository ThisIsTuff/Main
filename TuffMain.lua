local StuffYeah = {
    [14400545236] = 'https://raw.githubusercontent.com/ThisIsTuff/ArmWrestleSim/main/ClickSimulator.lua', -- Click Sim (game died)
    [15327837196] = 'https://raw.githubusercontent.com/ThisIsTuff/ArmWrestleSim/main/ClickSimulator.lua', -- Click Sim second world (game died)
    [13127800756] = 'https://raw.githubusercontent.com/ThisIsTuff/ArmWrestleSim/main/ArmWrestleSim.lua', -- AWS
    ...
    [15444929588] = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/ThisIsTuff/ArmWrestleSim/main/SkibidiTowerDefense.lua"))()' -- skibi tower defense (why did i make this?)
}
